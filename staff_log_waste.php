...
<head>
    ...
    <style>
        #size_wrapper, #unit_wrapper { display: none; } /* Hide by default */
            ...
            <section class="box" style="max-width: 500px; margin: 20px auto;">
                ...
                <form method="POST" action="staff_log_waste.php" id="logWasteForm" autocomplete="off">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <input type="number" name="quantity" required min="1" placeholder="e.g., 1" style="margin-bottom: 12px;">
                        <input type="text" id="unit_display" readonly placeholder="Unit" style="width: 100px; text-align: center; margin-bottom: 12px;">
                    </div>
